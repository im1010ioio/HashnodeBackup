...
除了 px 外，還有許多其他網頁上可以運用的絕對單位，但是較少用到，因為大多都是使用在印刷上，而網頁通常不會當成印刷的載體，總共有：
...
* 1.5em 就是 16px \* 1.5 = 24px，以此以此類推。
    

要注意的是，em 會加疊計算，若 em 內有 em 就會一直乘下去，所以使用要小心不要重疊，避免尺寸變得極大或極小。
